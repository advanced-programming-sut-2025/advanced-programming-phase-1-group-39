...
import com.StardewValley.models.Shops.BlackSmithShop;
import com.StardewValley.models.Shops.CarpentersShop;
import com.StardewValley.models.Shops.MarniesRanch;
...
public class GameController {
    ...
    public Result getLocation() {
        Location loc = App.getApp().getCurrentGame().getPlayerInTurn().getLocation();
