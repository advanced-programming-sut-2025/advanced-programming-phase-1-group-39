...
public enum Menu {
    ...
    MAIN_MENU("main menu", new MainMenuView(), new MainMenuScreen()),
    PROFILE_MENU("profile menu", new ProfileMenuView(), new ProfileMenuScreen()),
    GAME_MENU("game menu", new GameMenuView(), new GameScreen()),
    GAME("game", new GameView(), new GameScreen()),
    ExitMenu("exit", new ExitMenuView(), new SignupMenuScreen()),;
