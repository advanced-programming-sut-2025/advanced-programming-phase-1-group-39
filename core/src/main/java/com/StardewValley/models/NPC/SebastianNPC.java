...
public class SebastianNPC extends NPC {
    ...
    {
        super.dialogues = DialogueLoader.loadJsonToMap("projectData/resources/data/NPC/sebastianDialogues.json");
        ...
        super.missions = MissionsLoader.loadMissionsFromJson("projectData/resources/data/Missions/sebastianMissions.json");
