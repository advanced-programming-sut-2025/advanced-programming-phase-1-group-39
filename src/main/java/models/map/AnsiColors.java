...
public class AnsiColors {
    ...
    // - energy
    public static final String ANSI_LIGHT_GREEN_BOLD = getAnsiBoldColor(0, 156, 0);
    ...
    // TILE
    public static final String ANSI_WATERED_TILE_BACKGROUND = getAnsiBackGround(137, 84, 0);
    public static final String ANSI_PLOWED_TILE_BACKGROUND = getAnsiBackGround(157, 106, 27);
